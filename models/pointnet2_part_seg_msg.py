...
class get_model(nn.Module):
    def __init__(self, num_classes, normal_channel=False):
        ...
        self.sa1 = PointNetSetAbstractionMsg(512, [100, 200, 400], [32, 64, 128], 3 + additional_channel,[[32, 32, 64], [64, 64, 128], [64, 96, 128]])
        self.sa2 = PointNetSetAbstractionMsg(128, [400, 800], [64, 128], 128 + 128 + 64,[[128, 128, 256], [128, 196, 256]])
